...
import CouponFill from './CouponFill';
...
import HearthFill from './HearthFill';
...
import StarFillRating from './StarFillRating';
import StarSolidRating from './StarSolidRating';
...
import SecurityFill from './Security';
import TermFill from './TermFill';
import Exit from './Exit';
import StarFillV2 from './StarFillV2';
import VietnamFlag from './VietnamFlag';
import GermanyFlag from './GermanyFlag';
import AmericaFlag from './AmericaFlag';
import Checked from './Checked';
import OfficeFill from './OfficeFill';
...
import PalmoMini from './PalmoMini';
...
import ForgotPasswordDraw from './ForgotPassword';
import OrderConfirm from './Undraw/OrderConfirm';
import SecurityOn from './Undraw/SecurityOn';
import Magnify from './Magnify';
import Setting from './Setting';
import HaftStar from './HaftStar';
import Glasses from './Clothing/Glasses';
import Hat from './Clothing/Hat';
import Shoes from './Clothing/Shoes';
import Short from './Clothing/Short';
import Pant from './Clothing/Pant';
import Shirt from './Clothing/Shirt';
import HandBag from './Clothing/HandBag';
